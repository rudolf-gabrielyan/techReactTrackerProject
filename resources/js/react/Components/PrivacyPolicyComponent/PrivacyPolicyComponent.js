...
const PrivacyPolicyComponent = () => {
    return(
        <div className='privacyPolicyComponentContainer'>
            <p>Privacy Policy</p>
            <div>
                <p>What personal information do we collect from the people that visit our blog, website or app?</p>
                <p>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address, phone number, Social Links and more or other details to help you with your experience.</p>
            </div>
            <div>
            ...
            <div>
                <p>Do we disclose the information we collect to Third-Parties?</p>
                <p>We sell,trade, or otherwise transfer to outside parties your name, address,city,town, any form or online contact identifier email, name of chat account etc., screen name or user names, phone number</p>
            </div>
            <div>
                <p>We engage in this practice because:</p>
                <p>We sell data as a service. Personally Identifiable Information.</p>
            </div>
            <div>
            ...
            <div>
                <p>Google API</p>
                <p>If you choose to integrate your google account with Voogy we will only use the connection to read and send emails on your behalf. The reading of emails is simply to identify if there is a reply to the email to stop further emails from being sent. Our app uses the following Google API end points https://www.googleapis.com/auth/gmail.compose to send emails on your behalf, https://mail.google.com/ and https://www.googleapis.com/auth/contacts.readonly they are used to read replied to stop followup emails. This is used to ensure you can send emails and we stop email followup upon a reply. Voogy does not read your emails or content, we only scan for the subject and email adress.</p>
            </div>
            <div>
                <p>Opting out:</p>
            ...
            <div>
                ...
                <p>Within the guidelines set by the European Unions Data Directive.</p>
            ...
            <div>
                ...
                <p>Voogy IVS</p>
                <p>Forhaabningholms Alle 15</p>
                <p>Frederiksberg C, 1904</p>
                <p>Denmark</p>
                <p>info@voogy.com</p>
                <p><strong>Last Edited on 2017-10-16</strong></p>
            </div>
        </div>
    )
}
